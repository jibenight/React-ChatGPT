...
function Projects() {
  ...
  return (
    <div className='min-h-screen bg-linear-to-br from-gray-50 via-white to-gray-100 text-gray-900 dark:from-slate-950 dark:via-slate-950 dark:to-slate-900 dark:text-slate-100'>
      <div className='mx-auto max-w-6xl px-4 py-10'>
        ...
        <div className='mt-10 flex justify-center'>
          <Link
            to='/chat'
            className='inline-flex items-center justify-center rounded-full border border-gray-200 px-5 py-2 text-xs font-semibold text-gray-600 shadow-sm transition hover:border-teal-200 hover:text-teal-600 dark:border-slate-700 dark:text-slate-300 dark:hover:border-teal-500/40 dark:hover:text-teal-200'
          >
            Retour au chat
          </Link>
        </div>
