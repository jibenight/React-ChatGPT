          ...
          <div className="mt-10 flex items-center justify-center gap-4">
            {isAuthenticated ? (
              <div className="rounded-md shadow">
                <Link
                  to="/chat"
                  className="inline-flex items-center justify-center rounded-xl border border-transparent bg-teal-400 px-8 py-4 text-lg font-bold text-white shadow-lg transition duration-200 ease-in-out hover:bg-teal-500 focus:ring focus:ring-teal-200 dark:focus:ring-teal-400/30 md:py-4 md:text-xl"
                >
              ...
              <div className="rounded-md shadow">
                <button
                  onClick={() => setModalOpen("register")}
                  className="inline-flex cursor-pointer items-center justify-center rounded-xl border border-transparent bg-teal-400 px-8 py-4 text-lg font-bold text-white shadow-lg transition duration-200 ease-in-out hover:bg-teal-500 focus:ring focus:ring-teal-200 dark:focus:ring-teal-400/30 md:py-4 md:text-xl"
                >
